    ...
    const emails = [
      {
        ...
        html: `
          <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
            ...
            <p style="color:#999;font-size:12px;line-height:1.6;">Nuvora Â· AI Website Studio Â· South Africa<br>info@nuvoraweb.co.za Â· nuvoraweb.co.za</p>
          </div>
        `
      },
      {
        ...
        html: `
          <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
            ...
            <p style="color:#666;line-height:1.7;margin-bottom:16px;">Most South African business websites share the same problem â they are beautiful brochures that do absolutely nothing when no one is looking at them.</p>
            ...
            <p style="color:#999;font-size:12px;line-height:1.6;">Nuvora Â· info@nuvoraweb.co.za Â· <a href="https://nuvoraweb.co.za" style="color:#1A9B72;">nuvoraweb.co.za</a></p>
          </div>
        `
      },
      {
        delay: 5 * 24 * 60 * 60 * 1000, // 5 days
        subject: `How Bloom Events got 3Ã more enquiries in 6 weeks`,
        html: `
          <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
            <div style="margin-bottom:24px;"><span style="font-weight:700;font-size:18px;color:#062B23;">nu</span><span style="font-weight:700;font-size:18px;color:#0A0A0A;">vora</span></div>
            <h2 style="font-weight:700;font-size:22px;letter-spacing:-0.5px;color:#0A0A0A;margin-bottom:12px;">A quick story, ${firstName}.</h2>
            <p style="color:#666;line-height:1.7;margin-bottom:16px;">Bloom Events is a Johannesburg wedding and events company. Before Nuvora, they had a decent website â but it was silent. No leads coming in automatically. No follow-up system. Just a site that sat there waiting.</p>
            ...
            <div style="background:#EAF7F2;border-radius:12px;padding:20px;margin-bottom:20px;">
              <div style="display:flex;gap:24px;flex-wrap:wrap;">
                <div><div style="font-weight:700;font-size:24px;color:#1A9B72;">3.2Ã</div><div style="font-size:12px;color:#666;">More enquiries per month</div></div>
                <div><div style="font-weight:700;font-size:24px;color:#1A9B72;">4.9â</div><div style="font-size:12px;color:#666;">Google rating</div></div>
            ...
            <p style="color:#666;line-height:1.7;margin-bottom:24px;">The difference was not magic. It was a system â automated lead capture, smart review filtering, and a follow-up sequence that converts enquiries into bookings without any manual effort.</p>
            ...
            <p style="color:#999;font-size:12px;">Nuvora Â· info@nuvoraweb.co.za Â· <a href="https://nuvoraweb.co.za" style="color:#1A9B72;">nuvoraweb.co.za</a></p>
          </div>
        `
      },
      {
        ...
        html: `
          <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
            ...
            <div style="border-left:3px solid #1A9B72;padding-left:16px;margin-bottom:20px;">
              ...
              <p style="color:#666;line-height:1.7;font-size:14px;">One new client per month from your website pays for the entire Nuvora subscription â usually many times over. Most clients see their first conversion within 30 days.</p>
            </div>
            <div style="border-left:3px solid #1A9B72;padding-left:16px;margin-bottom:20px;">
              <p style="font-weight:600;color:#0A0A0A;margin-bottom:6px;">"Can I not just build it myself?"</p>
              <p style="color:#666;line-height:1.7;font-size:14px;">You could â but a DIY site typically takes weeks, lacks automation, and often looks it. Nuvora delivers a professional, fully automated system in 48 hours, maintained and updated monthly.</p>
            </div>
            ...
            <p style="color:#666;line-height:1.7;margin-bottom:24px;">Still have questions? Book a free call and we will answer everything honestly â no pressure, no pitch.</p>
      ...
      },
      {
        ...
        html: `
          <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
            ...
            <p style="color:#666;line-height:1.7;margin-bottom:16px;">If the timing is not right, no hard feelings at all â we will leave you alone from here.</p>
            ...
            <div style="background:#062B23;border-radius:12px;padding:20px;margin-bottom:24px;">
              ...
              <p style="color:#fff;font-weight:600;font-size:15px;margin-bottom:4px;">We are still onboarding our first 10 founding clients at launch pricing â no setup fee, locked-in monthly rate.</p>
            ...
            <p style="color:#999;font-size:12px;">Nuvora Â· info@nuvoraweb.co.za Â· <a href="https://nuvoraweb.co.za" style="color:#1A9B72;">nuvoraweb.co.za</a><br>You received this because you enquired via nuvoraweb.co.za.</p>
          </div>
        `
      }
    ];
