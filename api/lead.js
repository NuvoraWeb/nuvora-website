  ...
  if (process.env.RESEND_API_KEY) {
    try {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Nuvora Leads <info@nuvoraweb.co.za>',
          to: [process.env.LEAD_NOTIFY_EMAIL || 'info@nuvoraweb.co.za'],
          subject: `New lead: ${name} from ${business || 'unknown business'}`,
          html: `
            <div style="font-family:-apple-system,Arial,sans-serif;max-width:580px;margin:0 auto;padding:32px 24px;background:#fff;">
              ...
              <h2 style="font-weight:700;font-size:20px;color:#0A0A0A;margin-bottom:16px;">New lead received</h2>
